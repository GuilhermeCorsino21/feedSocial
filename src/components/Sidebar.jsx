    ...
    return (
        <aside className={styles.sidebar}>
            ...
            <div className={styles.profile}>
                <Avatar  src='https://media.licdn.com/dms/image/C4D03AQEwBzdQKw7e5A/profile-displayphoto-shrink_800_800/0/1643218915096?e=1682553600&v=beta&t=OIxaHuwjzBqKekBrlm4cJYGEcKfAe1eHOP5RqldW0YU'/>
